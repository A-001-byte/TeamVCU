/**
 * Burn Rate Page - Detailed view of burn rate analysis
 */

import { motion } from 'framer-motion';
import { useDashboardData } from '../hooks/useDashboardData';
import BurnRateDetail from '../components/BurnRateDetail';
...
function BurnRatePage() {
  ...
  const { financialTwin, burnRate, savings } = data || {};
    ...
    <div className="page-container">
      <div className="page-header">
        ...
        <div>
          ...
          <p className="page-subtitle">Time until savings depletion at current spending rate</p>
        </div>
      </div>
      ...
      >
        <BurnRateDetail 
          burnRate={burnRate} 
          monthlyExpense={financialTwin?.monthlyExpense}
          savings={savings || 60000}
        />
      </motion.div>
